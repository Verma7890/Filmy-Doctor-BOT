...
API_ID = int(environ['26795065'])
API_HASH = environ['02fdd0a1c8205dc41bea2f4b6784830a']
BOT_TOKEN = environ['6373873698:AAHc3bnkHAOZrP3_qeu0Uj1mu5SXhQwSIU4']
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '@Rjalex47').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://filmycloud2:Rohit7890@cluster0.8qe4ahy.mongodb.net/?retryWrites=true&w=majority")
...
# url shortner
SHORT_URL = environ.get("https://moneykamalo.com")
SHORT_API = environ.get("ae9d065c3444c76ec0aeaf326683f443e48b2122")
